...
export default function Home() {
  const roomsContent = (
    <section key="rooms" className="px-6 md:px-16 lg:px-32 min-h-screen py-12 flex items-center justify-center w-full">
  ...
  const activitiesContent = (
    <section key="activities" className="px-6 md:px-16 lg:px-32 min-h-screen py-12 flex items-center justify-center w-full">
  ...
  const instagramContent = (
    <section key="instagram" className="bg-[#fcf9f2] pt-10 pb-12 sm:pt-16 sm:pb-10 md:min-h-screen md:py-12 flex flex-col md:justify-center text-center overflow-hidden">
