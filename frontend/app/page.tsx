...
export default function Home() {
  ...
  const instagramContent = (
    <section key="instagram" className="bg-[#fcf9f2] pt-10 pb-4 sm:pt-16 sm:pb-10 md:min-h-screen md:py-12 flex flex-col md:justify-center text-center overflow-hidden">
